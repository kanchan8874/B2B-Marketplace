    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-neutral-600 mt-1">Communicate with buyers about your products</p>
        </div>
        <Button onClick={() => navigate('/seller/products')} variant="secondary" className="rounded-full">
          View Products
        </Button>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr,2fr]">
        {/* Conversations List */}
        <Card className="border-emerald-100 bg-gradient-to-br from-emerald-50/70 via-white/95 to-emerald-50/70">
          ...
          {conversations.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-xs text-neutral-500 mt-2">Buyers will contact you through product pages</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <p className="font-semibold text-neutral-900 truncate">
                          {conv.buyer?.name || conv.buyer?.companyName || 'Buyer'}
                        </p>
                        {conv.product && (
                      ...
                      {unreadCount > 0 && (
                        <span className="ml-2 flex-shrink-0 rounded-full bg-emerald-600 text-white text-xs font-semibold px-2 py-1 min-w-[24px] text-center">
                          {unreadCount}
                        </span>
                      )}
                    </div>
        ...
        {/* Messages View */}
        {selectedConversation ? (
          <Card className="border-emerald-100 bg-gradient-to-br from-emerald-50/70 via-white/95 to-emerald-50/70 flex flex-col h-[600px]">
            <div className="border-b border-neutral-200 pb-4 mb-4">
              <h2 className="text-lg font-semibold text-neutral-900">
                {selectedConversation.buyer?.name || selectedConversation.buyer?.companyName || 'Buyer'}
              </h2>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 mb-4 pr-2">
              {messages.length === 0 ? (
                ...
                messages.map((msg) => {
                  const isSent = msg.sender?.role === 'seller'
                  return (
                    <div
                      key={msg._id}
                    ...
                    >
                      ...
                      >
                        <p className="text-sm font-semibold mb-1">
                          {isSent ? 'You' : msg.sender?.name || 'Buyer'}
                        </p>
          ...
          <Card className="border-emerald-100 bg-gradient-to-br from-emerald-50/70 via-white/95 to-emerald-50/70 flex items-center justify-center h-[600px]">
            <div className="text-center">
